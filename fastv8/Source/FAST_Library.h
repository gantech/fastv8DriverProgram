...
EXTERNAL_ROUTINE void FAST_OpFM_Init(int * iTurb, double *TMax, char *InputFileName, int * TurbineID, int * NumSC2Ctrl, int * NumCtrl2SC, int * NumActForcePtsBlade, int * NumActForcePtsTower, float * TurbinePosition,
...
EXTERNAL_ROUTINE void FAST_Restart(int * iTurb, char *CheckpointRootName, int *AbortErrLev, int * NumOuts, double * dt, int * n_t_global, int *ErrStat, char *ErrMsg);
