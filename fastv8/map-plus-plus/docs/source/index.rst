...
MAP++ is designed to hook into other simulation codes through its API and can be customized to do a few things:
...
MAP++ follows the FAST Offshore Wind Turbine Framework :cite:`jonkman2013new` pattern.

More information on the theory behind MAP++ is described :cite:`masciola2013`. MAP++ is licensed under Apache version 2.
