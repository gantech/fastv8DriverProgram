...
if (Time .lt. 20.0) then
   PC_MinPit = 0.008726646259971648  ! 0.5 degree
else if (Time .lt. 40.0) then
   PC_MinPit = 0.017453292519943295  ! 1 degrees
else if (Time .lt. 60.0) then
   PC_MinPit = 0.04363323129985824   ! 2.5 degrees
end if
