...
REAL(4), PARAMETER           :: PC_KI         =       customPCKI               ! Integral gain for pitch controller at rated pitch (zero), (-).
...
REAL(4), PARAMETER           :: PC_KP         =       customPCKP                ! Proportional gain for pitch controller at rated pitch (zero), sec.
...
REAL(4), PARAMETER           :: PC_MinPit     =       customPCMinPit            ! Minimum pitch setting in pitch controller, rad.
