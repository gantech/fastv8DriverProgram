...
export nativeFAST=FAST${EXE_EXT}
export cFAST=FAST_ProgC${EXE_EXT}
...
cp -r $Fv8cDPRtest_DIR/5MW_Baseline $FAST_DIR/runFv8cDPRtest
...
cp $Fv8cDPRtest_DIR/testCases/Test01/makefile_DISCON_DLL $FAST_DIR/runFv8cDPRtest/testCases/Test01/
...
cp $Fv8cDPRtest_DIR/testCases/Test02/makefile_DISCON_DLL $FAST_DIR/runFv8cDPRtest/testCases/Test02/
...
# Test 07
#=============================================================================
if [ ! -d "$FAST_DIR/runFv8cDPRtest/testCases/Test07" ]; then
    mkdir $FAST_DIR/runFv8cDPRtest/testCases/Test07
fi

# cd $FAST_DIR/runFv8cDPRtest/testCases/Test07
# cp $Fv8cDPRtest_DIR/testCases/Test07/makefile_DISCON_DLL_sample $FAST_DIR/runFv8cDPRtest/testCases/Test07/
# cp $Fv8cDPRtest_DIR/testCases/Test07/tSample_Test07.fst $FAST_DIR/runFv8cDPRtest/testCases/Test07/
# cp $Fv8cDPRtest_DIR/testCases/Test07/5MW_Baseline $FAST_DIR/runFv8cDPRtest/testCases/Test07/ -r
# cp $Fv8cDPRtest_DIR/testCases/Test07/test07.sh $FAST_DIR/runFv8cDPRtest/testCases/Test07/
# run it...  
#./test07.sh
